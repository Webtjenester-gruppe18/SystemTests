...
#    Then The customer has 6 tokens
  ...
  Scenario: Money transfer
    ...
    Then The customer has 0 currency in the bank
    And The merchant has 200 currency in the bank
    And The customer has 5 tokens

    Scenario: Transaction overview
      Given The customer has made at least 1 transaction
